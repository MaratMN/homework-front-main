...
export const HW2 = () => {
  ...
  const filterUsers = (currentUsers: UserType[]) => {
    const filteredUsers = currentUsers.filter(u=> u.address.city === "Los Angeles") //'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
